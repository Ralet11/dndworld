    ...
    try {
        ...
        const campaignNpcs = [
            ...
            },
            {
                ...
                class: 'Agente',
                npc_type: 'neutral',
                notes: 'Tiefling Andii negro que aparece del lado de Prontera tras la toma de Costa Oscura. Se instal� dentro de la Torre del Don cerca de Osken Davra y Albert O''Brien, y se presenta como una l�nea disidente dentro de su propio pueblo. Dice querer impedir que los Andii completen sus planes y necesita la ayuda de Lucario para abrir una senda e infiltrarse del otro lado.',
            },
            {
                name: 'Teo Malvern',
                origin: 'Prontera',
                race: 'Humano',
                class: 'Pu�o de Prontera',
                npc_type: 'neutral',
                notes: 'Joven promesa de una casa importante de Prontera y uno de los Pu�os. Durante la sesi�n de adivinaci�n en la Torre del Don qued� marcado junto a Paleas y Zik, entr� en trance y se convirti� en canal de una fuerza mucho m�s oscura. Zik comprendi� que era el objetivo mostrado por el Dios Encadenado y lo mat� en el acto.',
            },
            {
                name: 'Dedos',
                origin: 'Costa Oscura',
                race: 'Humano',
                npc_type: 'amigo',
                notes: 'Miembro de la red Bonasera en la Taberna del Tuerto. Forma parte del n�cleo de apoyo que rodea a la party en Costa Oscura y, tras el rescate de Primo, pasa de contacto local cauteloso a aliado real dentro de la red de favores y movimientos del puerto.',
            },
            {
                name: 'Sony',
                origin: 'Costa Oscura',
                race: 'Humano',
                npc_type: 'amigo',
                notes: 'Integrante de la familia Bonasera ligada a la Taberna del Tuerto. Su peso est� en sostener el refugio, los v�nculos y la log�stica del grupo en Costa Oscura. Tras el rescate de Primo, queda alineado con la party como parte del entramado Bonasera.',
            },
            {
                name: 'Primo',
                origin: 'Costa Oscura',
                race: 'Humano',
                npc_type: 'amigo',
                notes: 'Miembro de los Bonasera y pieza emocional central del arco del puerto. Su desaparici�n durante la semana posterior a la toma de Costa Oscura termin� revelando que estaba cautivo de los Dientes Rotos. La party lo rescat� y, desde entonces, los Bonasera quedaron completamente alineados con el grupo.',
            },
        ];
