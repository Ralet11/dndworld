...
export function createEspadaCortaLookDevLights(
...
export function createEspadaCortaEnvironment(renderer: THREE.WebGLRenderer): THREE.Texture {
...
export function frameEspadaCortaCamera(
...
export function createEspadaCortaPresentationComposer(
...
export function configureEspadaCortaRenderer(renderer: THREE.WebGLRenderer): void {
...
export function createEspadaCortaInspectControls(
  camera: THREE.Camera,
