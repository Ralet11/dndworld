...
function makeProceduralTextureSet(
  ...
  // See createEspadaCortaModel.ts for why this check is stronger than a plain
  // `typeof document === 'undefined'` — RN/Hermes can have a document stub without a
  // real Canvas 2D implementation behind it.
...
export function createBallestaModel(options: ProceduralModelOptions = {}): THREE.Group {
  ...
  const mesh_bow_2Geometry = buildCurveSweepGeometry({"spine": [[-0.20,0.01,-0.020],[-0.13,0.018,-0.006],[-0.06,0.02,0.008],[0,0.0,0.012],[0.06,0.02,0.008],[0.13,0.018,-0.006],[0.20,0.01,-0.020]], "crossSection": {"points": [[-0.007,-0.0035],[0.007,-0.0035],[0.007,0.0035],[-0.007,0.0035]]}, "closed": false});
